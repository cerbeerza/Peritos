    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo_titulo', models.FileField(blank=True, null=True, upload_to='')),
                ('archivo_ci', models.FileField(blank=True, null=True, upload_to='Archivo/')),
                ('archivo_ant', models.FileField(blank=True, null=True, upload_to='')),
